  ...
  <div id="appPackage">
    ...
    <el-row style="margin: 5px;">
      <el-col :span="4" style="padding-top: 5px;">
        <span class="ml-3 w-35 text-gray-600 inline-flex items-center">分支:</span>
      </el-col>
      <el-col :span="12">
    ...
    <el-row style="margin: 5px;">
      <el-col :span="24">
        <el-button type="primary" plain @click="packageUatApp">uat打包</el-button>
        <el-button type="primary" plain @click="packageDebugApp">debug打包</el-button>
        <el-button type="primary" plain @click="packageProdApp">prod打包</el-button>
      </el-col>
    </el-row>

    <el-row style="margin: 5px;">
      <el-col :span="24">
        <el-button type="primary" plain @click="openLogWindows">查看日志</el-button>
        <!-- <el-button type="primary" @click="openSSHWindows">打开cmd</el-button> -->
        <el-button type="primary" plain @click="openShWindows">脚本设置</el-button>
      </el-col>
    </el-row>

    <el-row style="margin: 5px;">
      <el-col :span="4">
        <el-button plain @click="getFileList">刷新列表</el-button>
      </el-col>
      <el-col :span="20"></el-col>
    </el-row>

    <el-row class="mb-file-list">
      <el-col :span="24">
        <div id="tableData">
          <el-table :data="tableData" border>
            <el-table-column prop="fileName" label="文件名" width="170">
    ...
    <el-dialog v-model="shDialogVisible" :append-to-body=true title="脚本设置" width="90%">
      <div id="shWindows">
        <div id="">1.拉取分支</div>
        <div id="pre">
          <div>2.前置执行:</div>
    ...
    <el-dialog v-model="dialogVisible" :append-to-body=true title="日志" width="90%" @opened="onOpened">
